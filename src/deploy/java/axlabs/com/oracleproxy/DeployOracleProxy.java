 ...
 *
 * Usage:
 *   ./gradlew deploy -Powner=<owner_address> [-PmessageBridge=<message_bridge_address>] [-PnativeBridge=<native_bridge_address>] [-PwalletPath=<wallet_path>] [-PwalletPassword=<wallet_password>] [-PrpcUrl=<rpc_url>] [-PdryRun=true]
 *
...
public class DeployOracleProxy {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        // The DeploymentData struct has 3 Hash160 fields: owner, nativeBridge, messageBridge
